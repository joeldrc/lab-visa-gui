...
instrument_address = ['', 'TCPIP::localhost::INSTR', 'TCPIP::VNA-ZNB4-BI-BP-1::INSTR', 'TCPIP::VNA-ZNB4-BI-BP-2::INSTR', 'TCPIP::VNA-ZNB8-BI-BP::INSTR', 'TCPIP::AGILENTE5071C::INSTR']
